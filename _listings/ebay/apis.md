...
- name: Ebay Get Order Order Shipping Fulfillment Fulfillment
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/auctions/master/_listings/ebay/order-orderid-shipping-fulfillment-fulfillmentid-get-postman.md
x-common:
- type: x-blog
